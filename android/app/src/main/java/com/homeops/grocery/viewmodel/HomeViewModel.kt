        ...
        viewModelScope.launch {
            ...
            try {
                ...
                if (response.isSuccessful && response.body() != null) {
                    ...
                    _uiState.value = HomeUiState.Error("Failed to load dashboard: HTTP ${response.code()}")
                }
            } catch (e: Exception) {
        ...
        viewModelScope.launch {
            ...
            try {
                ...
                if (response.isSuccessful) {
                    _connectionState.value = ConnectionState.Success("Backend reachable – status: ${response.body()?.status}")
                } else {
